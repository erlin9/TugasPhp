...
include('../koneksi.php');	
if (($_POST[nama] != "")&&($_POST[nohp] != "")&&($_POST[asal_sekolah] != "")&&($_POST[email] != ""))
	{
if($_POST[add_photo]!=""){
...
?>
    ...
    <script>window.location.href='admin_pendaftaran_sukses.php?id=<?=$_POST[id_siswa];?>'</script>;
 <?php    
    }
	}
	else
	{
		...
		echo"<br><br>";
		echo"<a href='admin_pendaftaran_tambah.php'><center><b>Kembali</b></center></a>";
			echo"<br><br>";
} ?>