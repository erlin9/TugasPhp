...
<?php
//-----------------------------------menu utama
echo "<a href='admin_index.php?show=home1'><b>Menu Utama</b></a> | <a href='admin_index.php?show=berita1'><b>Admin Berita</b></a> | Admin Berita Tambah";
//-------------------------admin_galeri---------------------------------
echo"	<form enctype='multipart/form-data' method='post' action='admin_berita_tambah_nya.php'>
		...
		<table width='100%' border='0' cellpadding='0' cellspacing='0'>
			...
			<input type='text' class='validate[required] picker' name='tanggal' size='20' maxlength='50'/>
										</td>
									</tr>
									<tr>
										<td align='left' valign='top'>Judul</td>
										<td align='left' valign='top'>:</td>
										<td align='left' valign='top'><input type='text' name='judul' size='30'/></td>
									</tr>
									<tr>
										<td align='left' valign='top'>Sumber</td>
										<td align='left' valign='top'>:</td>
										<td align='left' valign='top'><input type='text' name='sumber' size='25'/></td>
									</tr>
									<tr>
										<td align='left' valign='top'>Isi Berita</td>
										<td align='left' valign='top'>:</td>
										<td align='left' valign='top'><textarea rows='10' cols='35' name='isi'>--Silahkan Di Isi Keterangan--</textarea></td>
									</tr>
									<tr>
										<td align='left' valign='top'>Foto</td>
										<td align='left' valign='top'>:</td>
										<td align='left' valign='top'><input type='file' name='photo' size='50'/></td>
									</tr>
									<tr>
										<td align='right' colspan='3'>&nbsp;</td>
									</tr><tr>
										<td align='right' colspan='3'><input type='submit' value='Simpan' name='add_photo'></td>
									</tr>
								</table>
						</td>
						<td width='5'>&nbsp;</td>
